...
{
    internal class SqlTextExpressionTranslator : ExpressionVisitor, ISqlExpressionTranslator
    {
        ...
        public SqlTextExpressionTranslator()
        {
        ...
        public string Translate(QueryExpression expression)
        {
            ...
            _builder.SqlParameters.Merge(((TextQueryExpression)expression).Parameters);
            ...
            Visit(((TextQueryExpression)expression).Expression);
